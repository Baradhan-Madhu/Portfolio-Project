...
- **Name**: Baradhan madhavan
- **Dot Number**: 43
- **Due Date**: 2/26/2026 @ 4:10 pm
...
I chose the ArtificialNeuron design because it connects to deep learning which powers modern AI systems like LLMs. Since we are living in an age where AI is rapidly influencing technology and society, this component feels practical and relevant. It also has more conceptual depth than the other options since it models a very besic version on neural networks.
...
- Designed a proof of concept for Artificial Neuron component
